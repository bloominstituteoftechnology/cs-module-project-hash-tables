...
class TestWordCount(unittest.TestCase):
    ...
    def test_word_count(self):
        ...
        self.assertEqual(x, {'hello': 2, 'my': 2, 'cat': 2, 'and': 1, "doesn't": 1, 'say': 1, 'back': 1})

        x = word_count('This is a test of the  Emergency  Broadcast  Network. This is only a test.')
        self.assertEqual(x, {'this': 2, 'is': 2, 'a': 2, 'test': 2, 'of': 1, 'the': 1, 'emergency': 1, 'broadcast': 1, 'network': 1, 'only': 1})
